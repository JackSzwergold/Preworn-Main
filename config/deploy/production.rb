...
after "deploy:create_symlink" do
  ...
  run "cd #{current_release} && ln -s #{web_builds}/image_ascii/production/current ascii"
  # Link the preworn slider stuff to 'slider'
  run "cd #{current_release} && ln -s #{web_builds}/preworn_slider/production/current slider"
  # Link the colorspace conversions stuff to 'colorspace'
  run "cd #{current_release} && ln -s #{web_builds}/colorspace_conversions/production/current colorspace"
